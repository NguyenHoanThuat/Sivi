...
import ImgProductWomen1 from "../../../assets/image/img-slide-best-product-4.jpg";
import ImgProductWomen2 from "../../../assets/image/img-slide-best-product-5.jpg";
...
export default function SlideProductAccess() {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
