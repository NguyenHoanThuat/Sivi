                  ...
                  <div className="menu-shop-center">
                    <div className="wrapper-menu-shop">
                      ...
                      <div className="menu-shop">
                        ...
                        <span className="menu-container">Product Grouped</span>
                        <span className="menu-container">Product Variable</span>
                        <span className="menu-container">Product On Sale</span>
                        <span className="menu-container">Product External</span>
                        <span className="menu-container">
                          Product Top Banner
                        </span>
                        <span className="menu-container">
